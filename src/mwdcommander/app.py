...
class AddPipeTallyLogForm(grok.AddForm):
    ...
    def add(self, **data):
        ...
        data['id'] = unicode(self.context['pipetallies'].tally_log_index)
        ...
        #add the tally log
        self.context['pipetallies'][unicode(self.context['pipetallies'].tally_log_index)] = obj
        self.context['pipetallies'].item_order.append(self.context['pipetallies'].tally_log_index)
        self.context['pipetallies'].tally_log_index += 1
